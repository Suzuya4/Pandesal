...
<?php
    ...
    //find the total number of result/rows stored in your database
    ...
    if (strlen($search) > 0){
        ...
        where transaction.employee_id = employee.id and transaction.office_id = office.id and transaction.documentcode= '. $search . ' ORDER BY transaction.documentcode, transaction.datelog LIMIT '.$page_first_result . ','. $result_per_page;    

    }else{
        $query = 'SELECT transaction.datelog, transaction.documentcode, transaction.action, office.name as office_name, CONCAT(employee.lastname," ,",employee.firstname) as employee_fullname, transaction.remarks FROM recordapp_db.employee, recordapp_db.office, recordapp_db.transaction 
        where transaction.employee_id = employee.id and transaction.office_id = office.id ORDER BY transaction.documentcode, transaction.datelog LIMIT '.$page_first_result . ','. $result_per_page;
    }
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-info bin-fill pull-right">Add New Transaction</button>
                                </div>
